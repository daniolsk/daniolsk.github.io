...
const Contact = () => {
  return (
    <div className="mt-5 flex h-full w-full flex-1 flex-col items-center justify-start overflow-auto lg:mt-0 lg:justify-center lg:gap-12 lg:px-[10vw]">
      <div className="animate-fadein relative mx-6 my-4 flex flex-col gap-2 border-2 border-white bg-gradient-to-b from-gray-900 to-violet-900 p-4 text-white sm:px-14 lg:mx-0 lg:p-6 xl:p-12">
